...
class Counter {
    /*
    If u use a single data for different threads, you have to synchronize the method, otherwise
    you will get different outputs in every execution

    To synchronize a method just using "synchronize" keyword before access modifier is enough
     */
